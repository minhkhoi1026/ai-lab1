...
function utility(𝒫::Union{POMDP, POMG}, b, π)
...
function ConditionalPlan(𝒫::Union{POMDP, POMG}, a, plans)
    subplans = Dict(o=>π for (o,π) in zip(𝒫.𝒪, plans))
    return ConditionalPlan(a, subplans)
end

function combine_lookahead(𝒫::Union{POMDP, POMG}, s, a, Γo)
...
function combine_alphavector(𝒫::Union{POMDP, POMG}, a, Γo)
